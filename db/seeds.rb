...
pokemon2 = Pokemon.create! ( { name: "Chimchar", pokemontype: "Fire", region: "Unova", image_url: "https://vignette3.wikia.nocookie.net/pokemon/images/7/76/390Chimchar.png/revision/latest?cb=20141229230356" })

pokemon3 = Pokemon.create! ( { name: "Piplup", pokemontype: "Water", region: "Sinnoh", image_url: "https://vignette3.wikia.nocookie.net/pokemon/images/b/b1/393Piplup.png/revision/latest?cb=20141229230319" })

pokemon4 = Pokemon.create! ( { name: "Emolga", pokemontype: "Eletric/Flying", region: "Unova", image_url: "https://vignette2.wikia.nocookie.net/pokemon/images/b/b4/587Emolga.png/revision/latest?cb=20140329051920" })

pokemon5 = Pokemon.create! ( { name: "Gigalith", pokemontype: "Rock", region: "Unova", image_url: "https://vignette2.wikia.nocookie.net/pokemon/images/5/59/526Gigalith.png/revision/latest?cb=20140329045352" })

pokemon6 = Pokemon.create! ( { name: "Treecko", pokemontype: "Grass", region: "Hoenn", image_url: "https://vignette2.wikia.nocookie.net/pokemon/images/2/2c/252Treecko.png/revision/latest?cb=20140629190010" })

pokemon7 = Pokemon.create! ( { name: "Torchic", pokemontype: "Fire", region: "Hoenn", physiology: "Torchic is a small, chick-like Pokémon. Its soft, fluffy plumage is mainly bright orange, with tiny, yellow, developing wings, and a yellow plume of three feathers atop its head. It has a small, tan beak, and large, black eyes. It has tan-colored talons with three digits. Male Torchics have a black spot on their back, but it's a little hard to see it.", special_abilities: "Torchic has a fireball blazing inside its belly. When hugged, it fills its trainer with soothing warmth, as if they are holding a hot-water bottle. It can use the flame in its belly to exhale orbs of searing fire at its opponents. The fireballs that Torchic spits are of 1,800 degrees F, leaving its foes utterly scorched.", behavior: "Torchic is very loyal and dependent on its Trainer, following behind him (or her) everywhere he (or she) would go.", evolution: "Torchic evolves into Combusken at level 16 and then i
...
pokemon8 = Pokemon.create! ( { name: "Mudkip", pokemontype: "Water", region: "Hoenn", image_url: "https://vignette1.wikia.nocookie.net/pokemon/images/6/60/258Mudkip.png/revision/latest?cb=20140629190045" })

pokemon9 = Pokemon.create! ( { name: "Bulbasaur", pokemontype: "Grass", region: "Kanto", image_url: "https://vignette4.wikia.nocookie.net/pokemon/images/2/21/001Bulbasaur.png/revision/latest?cb=20140328190757" })
